...
var liner = function (exports, asmCrypto, elliptic) {
  ...
  var Debug = function () {
    ...
    _createClass(Debug, null, [{
      ...
      get: function get() {
        if (typeof self !== "undefined") {
          return self.PV_WEBCRYPTO_LINER_LOG
        }
        return typeof window !== "undefined" && window.PV_WEBCRYPTO_LINER_LOG;
      }
    }, {
      key: "log",
      value: function log() {
  ...
  function BrowserInfo() {
    ...
    var userAgent = typeof self === "undefined" ? window.navigator.userAgent : self.navigator.userAgent;
  ...
  exports.crypto = new Crypto$1();
  exports.setCrypto = setCrypto;
  return exports;
}({}, typeof self === 'undefined' ? window.asmCrypto : self.asmCrypto, typeof self === 'undefined' ? window.elliptic : self.elliptic);
